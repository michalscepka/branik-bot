...
public class PriceService : IPriceService
{
    ...
    public PriceService(IMemoryCache cache, IHttpClientFactory httpClientFactory,
        ILogger<PriceService> logger, IOptions<CashingConfiguration> cashingConfiguration)
    {
        _cache = cache;
